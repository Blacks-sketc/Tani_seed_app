...
def save_to_excel():
    ...
    worksheet_name = 'Sheet1'  # Ganti dengan nama worksheet Anda
    ...
    # Tambahkan DataFrame ke Google Sheets
    worksheet.clear()  # Hapus data yang sudah ada
    gc.df_to_sheet(df, index=False, sheet=worksheet, start='A1', replace=True)
...
def total():
    if st.button("Total"):
        ...
        st.image('captain america shield2.jpg')
